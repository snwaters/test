...
start /wait powershell.exe -Command "Invoke-WebRequest -Uri https://raw.githubusercontent.com/snwaters/test/refs/heads/main/ScriptPart4.bat.ps1 -OutFile C:\osdcloud\Scripts\SetupComplete\ScriptPart4.bat
